...
- **Набор правил** — значение, описывающее вариант счёта: классический (число сетов, золотое очко, тай-брейк) либо до N очков (N, X). Именно значение, а не ветвление в коде: «играем до 9 геймов» должно становиться другим числом, а не другой веткой.
