...
**Доставка матча**:
Переезд законченного матча с часов на телефон, где он становится историей. Случается сама, без участия игрока, и тогда, когда телефон окажется доступен, — во время игры он не нужен. Матч считается доставленным по подтверждению, а не по отправке: до подтверждения часы остаются единственным местом, где матч есть (ADR-0002). Один и тот же матч может приехать дважды — телефон узнаёт его по идентификатору и второго не заводит.
_Avoid_: синхронизация, выгрузка, sync (двусторонним обменом это не является)
